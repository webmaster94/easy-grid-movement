...
- Movement ranges use Foundry v14's native grid-highlight layer with 80%-opacity dotted grid edges instead of map-obscuring area fills. Only the green-to-yellow zone transition uses a solid edge; walls, fog, terrain blockers, and other unreachable boundaries remain dotted.
